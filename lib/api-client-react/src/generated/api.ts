...
export const sendOpenaiMessage = async (id: number,
    openaiMessageInput: OpenaiMessageInput, options?: RequestInit): Promise<void> => {
...
export const sendOpenaiVoiceMessage = async (id: number,
    openaiVoiceMessageInput: OpenaiVoiceMessageInput, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getSendOpenaiVoiceMessageUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRunRoutineUrl = (id: number,) => {




  return `/api/routines/${id}/run`
}

/**
 * @summary Run a routine
 */
export const runRoutine = async (id: number, options?: RequestInit): Promise<RoutineRunResult> => {

  return customFetch<RoutineRunResult>(getRunRoutineUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getRunRoutineMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof runRoutine>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof runRoutine>>, TError,{id: number}, TContext> => {

const mutationKey = ['runRoutine'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof runRoutine>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  runRoutine(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RunRoutineMutationResult = NonNullable<Awaited<ReturnType<typeof runRoutine>>>

    export type RunRoutineMutationError = ErrorType<unknown>

    /**
 * @summary Run a routine
 */
export const useRunRoutine = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof runRoutine>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof runRoutine>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getRunRoutineMutationOptions(options));
    }
